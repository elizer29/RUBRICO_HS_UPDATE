...
<a href="LogIn.php"><button class="btn btn-primary" id="btn_Login">Login To Admin</button></a>
<h2>HOME</h2>
    ...
    <div class="active item"><img src="images/Hospital-Reviews.jpg" class="img"/></div>
    <div class="item"><img src="images/hospital.jpg" class="img"/></div>
...
<div class="indent">A <em>hospital</em> is a health care institution providing patient treatment by specialized staff and equipment.<br />
